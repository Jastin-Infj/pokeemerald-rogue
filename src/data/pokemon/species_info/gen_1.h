...
#define PIDGEOT_MISC_INFO                                   \
    ...
    [SPECIES_PIDGEOT] =
    {
        ...
        .expYield = 216,
        .abilities = { ABILITY_KEEN_EYE, ABILITY_TANGLED_FEET, ABILITY_SNIPTERON },
        .cryId = CRY_PIDGEOT,
        .height = 15,
        .weight = 395,
        .description = POKEDEX_DESC_STRING(
...
#define RATICATE_MISC_INFO                  \
    ...
    [SPECIES_FEAROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_KEEN_EYE, ABILITY_SNIPTERON, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FARFETCHD_MISC_INFO                                 \
    ...
    [SPECIES_DODRIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_RUN_AWAY, ABILITY_EARLY_BIRD, ABILITY_SNIPTERON },
        .bodyColor = BODY_COLOR_BROWN,
